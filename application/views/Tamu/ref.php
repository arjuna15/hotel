...
<html lang="en">
  ...
  <?php $this->load->view('master/navtamu')?>
    ...
    <div class="container">
        <div class="card mb-3">
            <img src="<?php echo base_url('/assets/img/hotel.jpg'); ?>" class="card-img-top" alt="...">
            <div class="card-body">
    ...
    <script src="<?php echo base_url('/public/js/bootstrap.bundle.min.js'); ?>""https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ka7Sk0Gln4gmtz2MlQnikT1wXgYsOg+OMhuP+IlRH9sENBO0LRn5q+8nbTov4+1p" crossorigin="anonymous"></script>
